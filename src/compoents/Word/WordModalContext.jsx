...
const WordModalContext = ({ onClose }) => {
  ...
  return (
    <>
      <div>
        <h2 className="my-10 text-lg font-bold text-center">
          Challenge Completed!
        </h2>
      ...
      <div className="flex justify-center gap-5">
        <Button className="p-2 text-[0.7rem]" onClick={playAgainHandler}>
          네! 또 할래요!
        </Button>
        <Button className="p-2 text-[0.7rem]" onClick={onClose}>
          아니오. 안 할래요...
        </Button>
      </div>
    </>
