...
const InputOne = ({ onKeyDown, onClickIcon, btnText, children, inputRef }) => {
  return (
    <>
      <div className="w-full px-4  py-4 ">
        <div className="relative w-full min-w-[200px] h-10">
          ...
          <button
            onClick={() => onClickIcon()}
            className="!absolute cursor-pointer right-1 top-1  rounded bg-blue-500 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white transition-all   active:shadow-none disabled:pointer-events-none disabled:bg-gray-600 disabled:cursor-none disabled:shadow-none"
            type="button"
          >
            {btnText}
          </button>
